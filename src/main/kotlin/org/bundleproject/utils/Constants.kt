...
val githubAuth =
    listOf(
        env("GITHUB_AUTH_USER")
            ?: throw IllegalArgumentException("No github username/clientid provided"),
        env("GITHUB_AUTH_PASS")
            ?: throw IllegalArgumentException("No github password/secret provided")
    )
